...
/** 
 ...
 set in VPContentMetadata
 */
typedef NS_ENUM(NSUInteger, VPContentForm) {
  /// Unknown content form
  VPContentFormUnknown = 0,
 ...
 */
@interface VPContentMetadata : NSObject

- (id)copyExistingProperties:(VPContentMetadata *)sourceCm
     OverrideContentMetadata:(VPContentMetadata *)overrideCm;
/**
 ...
 */
@property (nonatomic, assign) VPContentForm contentForm;
