...
/// The delegate of a VPAdManager object must adopt the VPAdManagerDelegate protocol.
/// The methods of the protocol informs the delegate of the proper time to
/// start playing content and ads.
