...
- (void)addTestCases {
  [self addCommonWithTitle:@"Channel" embedCode:@"8wcHl5ZDE6WaN2FVc4-SkvjI2OaS9aCC" pcode:@"M0MmsyOkCyNf73-ACexLodKFqJYt"];
  [self addCommonWithTitle:@"Event" embedCode:@"IyY3QzZTE6tmwdJvP1Zf7hIyVHcxckic" pcode:@"M0MmsyOkCyNf73-ACexLodKFqJYt"];
